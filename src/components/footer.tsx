export default function Footer() {
  ...
  return (
    <footer className="bg-[#f3ede7] dark:bg-[#150e09] py-12 px-6 lg:px-10">
      <div className="max-w-360 mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
        <div className="space-y-4">
          ...
          <p className="text-sm text-[#9a734c] max-w-xs">
            Connecting pet lovers through micro-donations to support shelters worldwide. Every pixel
            counts.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <h3 className="font-bold text-sm uppercase tracking-wider text-[#9a734c]">Community</h3>
          <a className="text-sm hover:text-primary transition-colors" href="#">
            Success Stories
          </a>
          <a className="text-sm hover:text-primary transition-colors" href="#">
        ...
        <div className="space-y-4">
          <h3 className="font-bold text-sm uppercase tracking-wider text-[#9a734c]">Newsletter</h3>
          ...
          <div className="flex gap-4 pt-2">
            <a className="text-[#9a734c] hover:text-primary transition-colors" href="#">
      ...
      <div className="max-w-[1440px] mx-auto mt-12 pt-8 border-t border-[#e8dfd5] dark:border-[#2d241d] text-center text-xs text-[#9a734c]">
        © {year} Pixel Dog. A micro-philanthropy platform for all creatures great and small.
      </div>
    </footer>
  );
}
